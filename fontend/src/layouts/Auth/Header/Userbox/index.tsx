		...
		<>
			...
			>
				...
				<List sx={{ p: 1 }} component="nav">
					<ListItem button to={login === true ? "/profile/details" : "dang-nhap"} component={NavLink}>
						<AccountBoxTwoToneIcon fontSize="small" />
						<ListItemText primary={login === true ? "Thông Tin" : "Đăng Nhập"}/>
					</ListItem>
					<ListItem
						button
						to={login === true ? "/profile/settings" : "dang-ki"}
						component={NavLink}
					>
				...
				<Box sx={{ m: 1 }} display={login === true ? "block" : "none"}>
					<Button color="primary" fullWidth onClick={()=>dispatch(authActions.logout())}>
						<LogoutIcon sx={{ mr: 1 }} />
						Đăng Xuất
					</Button>
				</Box>
